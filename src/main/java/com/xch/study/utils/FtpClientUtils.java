...
public class FtpClientUtils {
    private static final Logger logger = Logger.getLogger(String.valueOf(FtpClientUtils.class));
     ...
     * @return
     */
    public FtpClientUtils setConfig(String host, String username, String password) {
        this.host = host;
     ...
     * @param password
     */
    public FtpClientUtils setConfig(String host, int port, String username, String password) {
        this.host = host;
        this.port = port;
        this.username = username;
        this.password = password;
     ...
     * 连接FTP服务器
     */
    private FtpClientUtils connectServer() {
    ...
    public List<File> download() {
        ...
        try {
            ...
            if (ftpFiles.length == 0) {
                System.out.println("文件数为0，没有可下载的文件！");
                return null;
            }
    ...
    public void upload(List<File> files) {
        ...
        try {
            ...
            if (files == null || files.size() == 0) {
                System.out.println("文件数为0，没有找到可上传的文件");
                return;
            }
    ...
    public OutputStream getOutputStream(String fileName) {
        ...
        try {
            ...
            System.out.println("服务器上创建文件对象失败" + e.getMessage());
    ...
    public boolean isFileExist(String fileName) {
        ...
        try {
            ...
            System.out.println("检查文件是否存在失败" + e.getMessage());
    ...
    public String toString() {
        return "FtpClientUtils [host=" + host + ", port=" + port + ", username="
